document.addEventListener('DOMContentLoaded', function () {
    ...
    const animatedElements = document.querySelectorAll('.section-title, .project-card, .timeline-item, .skill-card, .pub-card');
        ...
        endChatBtn.addEventListener('click', () => {
            if (confirm("Are you sure you want to end the interview? I'll send a summary to Vijay.")) {
                ...
                messages.forEach(msg => {
                    ...
                    const text = msg.innerText.replace("AI Assistant:", "").replace("You:", "").trim();
                    if (text && text !== "Typing...") {
    ...
    const badges = [
        ...
        { file: "Community_competitor.svg", title: "Community Competitor", issuer: "Kaggle" },
        { file: "Dataset_Contributor.svg", title: "Dataset Contributor", issuer: "Kaggle" },
        { file: "Github_Coder.svg", title: "GitHub Coder", issuer: "Kaggle" },
        { file: "Kaggle_Award.svg", title: "Kaggle Award", issuer: "Kaggle" },
        { file: "Notebook_Modeler.svg", title: "Notebook Modeler", issuer: "Kaggle" },
